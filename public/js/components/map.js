...
const map = {
    ...
    controller: ["PlayerService", function(PlayerService) {
        ...
        vm.storyText = "Zeus has followed your journey from the Underworld, across the ocean and your encounters with the Cyclops and Prometheus. “I did not expect you to make it this far. You are still a mere mortal”. A lighting bolt appears in his hand. Zeus is the last thing standing between you and your loved ones!"
        vm.i = 0;
        vm.speed = 40;
